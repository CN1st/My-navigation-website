YL.static = {
  /** “关于”信息 */
  softwareName: 'WangXiaohang', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: '王孝航(powered by ylui)',//作者
  contactInformation: 'wangxiaohang@wangxiaohang.com',//联系方式
  officialWebsite: 'https://wangxiaohang.com',//软件官网
  welcome: '本网站UI由 YLUI 强力驱动\n更多信息：//ylui.yuri2.cn',//加载完毕控制台提示信息
  copyrightDetail: '数据接口：By.WangXiaohang UI:By.ylui',//版权详细信息
